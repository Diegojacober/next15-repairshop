...
import SelectWithLabel from "@/components/inputs/SelectWithLbael";
...
import { saveCustomerAction } from "@/app/actions/CustomerAction";
...
export default function CustomerForm({ customer, isManager = false }: Props) {
  ...
  }, [searchParams.get("customerId")]); // eslint-disable-line react-hook/exhaustive-deps
